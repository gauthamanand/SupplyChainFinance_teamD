...
public class ConsumeRestService {
	...
	public String getInvoice(int invoiceId)
	{
		try {
			...
			WebResource webResource = client
			   .resource("http://localhost:8089/payments/services/Stubs/GetInvoice?InvoiceId="+String.valueOf(invoiceId));
	...
	public String getUser(String userid)
	{
		try {
			...
			WebResource webResource = client
			   .resource("http://localhost:8089/payments/services/Stubs/GetUser?userid="+userid);
